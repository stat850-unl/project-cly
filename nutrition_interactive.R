...
library(tidyr)
library(ggplot2)
food_component <- read.csv("https://raw.githubusercontent.com/stat850-unl/project-nutrition/master/datasets/food_component.csv")
food_nutrient <- read.csv("https://raw.githubusercontent.com/stat850-unl/project-nutrition/master/datasets/food_nutrient.csv")
nutrient <- read.csv("https://raw.githubusercontent.com/stat850-unl/project-nutrition/master/datasets/nutrient.csv")
